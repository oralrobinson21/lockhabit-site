...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4" data-lh-not-found="true">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LOCKHABIT SOAP CO. | Natural Rituals Since Forever" },
      {
        name: "description",
        content:
          "LOCKHABIT Soap Co. — twelve tropical botanical bars for permanent vacation energy.",
      },
      { name: "author", content: "LOCKHABIT" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Fraunces:ital,opsz,wght@0,9..144,400..800;1,9..144,400..800&family=Figtree:wght@400;500;600;700;800;900&display=swap",
      },
